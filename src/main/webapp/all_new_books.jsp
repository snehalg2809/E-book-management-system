					...
					<div class="card crd-ho mt-2">
						<div class="card-body text-center">
							...
							<div class="row">
								...
								if (u == null) {
								%>
								<a href="login.jsp" class="btn btn-warning  btn-sm ml-1">Add Cart</a>
								<%
								} else {
								%>
								<a href="cart?bid=<%=b.getBookId() %>&&uid=<%=u.getId() %>" class="btn btn-warning  btn-sm ml-1">Add Cart</a> 
								<%
								}
								%>
								 ...
								 <a href="view_books.jsp?bid=<%=b.getBookId()%>"
									...
									href="" class="btn btn-dark  btn-sm mt-1 ml-1"><i
									class="fas fa-rupee-sign"></i><%=b.getPrice()%></a>
